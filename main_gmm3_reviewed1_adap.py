...
from model_gmm3_reviewed1_adap import GraphFrontDoorAdapter
...
def add_adapter_frontdoor_args(parser):
    ...
    parser.add_argument('--lambda_env_swap', type=float, default=0.1,
                        help='weight of spurious-branch swap invariance loss')
    parser.add_argument('--lambda_causal_swap', type=float, default=0.1,
                        help='weight of different-label mediator swap effect loss')
    parser.add_argument('--lambda_env_pred', type=float, default=0.05,
                        help='weight of environment prediction loss on spurious branch')
    parser.add_argument('--lambda_causal_env', type=float, default=0.0,
