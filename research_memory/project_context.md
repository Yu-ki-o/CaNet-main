...
- Causal representation stability and EBR: `P009`
...
The current HSIC+EBR model already uses CGRL-style energy-based reconstruction on the mediator. `P009` suggests treating this as a representation-stability module, then adding mediator class compactness/separation and MI-stability diagnostics before introducing another large causal mechanism.
...
`P009` makes Cora/Citeseer/Pubmed useful for quick MI-stability checks under feature shifts, while Arxiv/Twitch test whether EBR and mediator compactness survive temporal or spatial shifts at scale.
