...
class GraphFrontDoorDAG(nn.Module):
    ...
    def compute_edge_semantic_summary(self, h, edge_index, training=False):
        ...
        # Relation-aware aggregation. The selected edge feature mode can use
        # only multiplicative interaction, only absolute difference, a soft
        # degree prior, or their combinations. The degree scalar is used only
        # for edge reliability, not as a direct node-label feature.
