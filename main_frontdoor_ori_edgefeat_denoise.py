...
from model_frontdoor_ori_edgefeat_denoise import GraphFrontDoor
...
def add_frontdoor_args(parser):
    ...
    parser.add_argument('--edge_score_temp', type=float, default=2.0,
                        help='temperature for edge relevance gates')
    parser.add_argument('--edge_blend', type=float, default=0.2,
                        help='blend ratio for edge-aware node representation enhancement')
    parser.add_argument('--edge_feat_mode', type=str, default='mul_diff',
                        ...
                        help='edge feature construction mode for edge-aware node enhancement')
    parser.add_argument('--use_neighbor_denoise', action='store_true',
                        help='subtract low-relevance neighbor summary from node representations')
    parser.add_argument('--noise_subtract_alpha', type=float, default=0.1,
                        help='strength for optional low-relevance neighbor denoising')
    parser.add_argument('--noise_gate_temp', type=float, default=1.0,
                        help='temperature for optional neighbor denoising gate')
