...
from model_gmm3_reviewed1_adap_invariant import GraphFrontDoorAdapter
...
def add_adapter_frontdoor_args(parser):
    ...
    parser.add_argument('--virtual_blend', type=float, default=0.2,
                        help='master strength of ego-out invariant enhancement')
    parser.add_argument('--virtual_stable_blend', type=float, default=1.0,
                        help='extra scale for stable ego-out feature injection')
    parser.add_argument('--virtual_suppress_blend', type=float, default=0.05,
                        help='strength of feature-wise suppression from ego-out disagreement')
    parser.add_argument('--virtual_gate_temp', type=float, default=1.0,
                        help='temperature for invariant/suppression gates')
...
print(
    f"[INFO] Training recipe: clean adapter front-door + invariant ego-out | "
