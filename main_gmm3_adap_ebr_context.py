...
from model_gmm3_adap_ebr_context import GraphFrontDoorDAG
...
def add_frontdoor_dag_args(parser):
    ...
    parser.add_argument('--ebr_neg_ratio', type=float, default=1.0,
                        help='negative edge ratio for EBR pairwise NCE/BCE')
    ...
    parser.add_argument('--ebr_kl_weight', type=float, default=0.1,
                        help='weight of neighbour-posterior KL inside EBR')
    parser.add_argument('--ebr_nce_weight', type=float, default=1.0,
                        help='weight of pairwise positive-vs-negative NCE inside EBR')
    ...
    parser.add_argument('--ebr_kl_direction', type=str, default='p_to_q', choices=['p_to_q', 'q_to_p'],
                        help='KL direction for EBR neighbour posterior; p_to_q is usually more stable')
...
print(
    ...
    f"EBR: lambda={args.lambda_ebr}, temp={args.ebr_temperature}, "
