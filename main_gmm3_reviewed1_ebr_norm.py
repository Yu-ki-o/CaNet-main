...
from model_gmm3_reviewed1_ebr_norm import GraphFrontDoorDAG
...
def add_frontdoor_dag_args(parser):
    ...
    parser.add_argument('--ebr_bce_weight', type=float, default=1.0,
                        help='inside-EBR weight of positive/negative edge reconstruction BCE')
    parser.add_argument('--ebr_kl_weight', type=float, default=1.0,
                        help='inside-EBR weight of local edge-posterior KL alignment')
...
print(
    ...
    f"max_edges={args.ebr_max_edges}, bce={args.ebr_bce_weight}, kl={args.ebr_kl_weight}, "
